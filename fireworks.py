...
class Firework:
    ...
    def explode(self):
        self.exploded = True
        num_of_projectiles = random.randrange(self.MIN_PROJECTILES, self.MAX_PROJECTILES)
        if random.randint(0, 1) == 0:
            self.create_circular_projectile(num_of_projectiles)
        else:
            self.create_star_projectiles()


    def create_circular_projectile(self, num_of_projectiles):
...
def main():
    ...
    launchers = [Launcher(100, HEIGHT - Launcher.HEIGHT, 3000), Launcher(500, HEIGHT - Launcher.HEIGHT, 4000), Launcher(900, HEIGHT - Launcher.HEIGHT, 2000), Launcher(1200, HEIGHT - Launcher.HEIGHT, 5000)]
